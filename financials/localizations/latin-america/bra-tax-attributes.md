...
ms.openlocfilehash: eda0c1637f7a192112111bcb6cb3853f2bad8d73
ms.lasthandoff: 02/22/2017


---

# <a name="tax-attributes-for-brazil"></a>Tax attributes for Brazil

This topic explains how to set up fiscal information for addresses, legal entities, customers, and vendors, and for products that are released to a Brazilian legal entity. This information is required for tax calculation, and for fiscal documents and other required statements that you submit from Fiscal books.

<a name="tax-address-attributes"></a>Tax address attributes
----------------------
...
## <a name="customer-tax-attributes"></a>Customer tax attributes
...
## <a name="vendor-tax-attributes"></a>Vendor tax attributes
...
## <a name="product-tax-attributes"></a>Product tax attributes
