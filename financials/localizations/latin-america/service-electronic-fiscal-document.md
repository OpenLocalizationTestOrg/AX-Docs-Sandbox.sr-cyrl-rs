...
ms.openlocfilehash: 1310071a8d3820b3d4e5f9203f04fdc77e06d1e1
ms.lasthandoff: 02/22/2017


---

# <a name="service-electronic-fiscal-document-for-brazil"></a>Service electronic fiscal document for Brazil
...
## <a name="recibo-provisorio-de-servicos-rps-document"></a>Recibo Provisorio de Servicos (RPS) document
...
### <a name="rps-with-configurator"></a>RPS with configurator
...
### <a name="rps-with-electronic-reporting"></a>RPS with electronic reporting
...
#### <a name="service-code-configuration"></a>Service code configuration
...
#### <a name="services-on-delivery-address"></a>Services on delivery address
...
## <a name="export-and-import-rps-files"></a>Export and import RPS files
