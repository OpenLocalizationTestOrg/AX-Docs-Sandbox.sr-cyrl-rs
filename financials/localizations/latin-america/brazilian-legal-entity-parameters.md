...
ms.openlocfilehash: 5324d252f71d5b592c34c786b34b9ce400a22908
ms.lasthandoff: 02/22/2017


---

# <a name="parameters-for-legal-entities-in-brazil"></a>Parameters for legal entities in Brazil
...
<a name="brazilian-legal-entity-overview"></a>Brazilian legal entity overview
-------------------------------
...
## <a name="fiscal-establishments"></a>Fiscal establishments
...
### <a name="closed-warehouse"></a>Closed warehouse
...
### <a name="tax-substitution"></a>Tax substitution
...
### <a name="nf-e-and-nfc-e-federal"></a>NF-e and NFC-e federal
...
#### <a name="nf-e-web-service"></a>NF-e web service
...
#### <a name="nfc-e-web-service"></a>NFC-e web service
...
#### <a name="email-templates"></a>Email templates
...
#### <a name="security-page-contingency"></a>Security page contingency
...
### <a name="tax-registration-numbers"></a>Tax registration numbers
...
## <a name="brazilian-parameters"></a>Brazilian parameters
...
### <a name="taxation-code"></a>Taxation code
...
## <a name="accountant-information"></a>Accountant information
