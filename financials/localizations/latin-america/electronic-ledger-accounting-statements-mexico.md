...
# <a name="electronic-ledger-accounting-statements"></a>Electronic ledger accounting statements
...
### <a name="sat-account-group"></a>SAT account group
...
### <a name="bank-transactions"></a>Bank transactions
...
### <a name="invoice-identification"></a>Invoice identification
...
## <a name="generate-electronic-ledger-accounting-files"></a>Generate electronic ledger accounting files
