...
ms.openlocfilehash: d7ecfe74288af67fb94de257bbef9c6f5af6babf
...
## <a name="how-is-depreciation-calculated-using-the-equally-divided-depreciation-method"></a>How is depreciation calculated using the equally divided depreciation method?
...
## <a name="how-is-equally-divided-depreciation-calculated-for-a-lowvalue-asset-that-is-acquired-midyear"></a>How is equally divided depreciation calculated for a lowvalue asset that is acquired midyear?
...
## <a name="how-is-equally-divided-depreciation-calculated-for-a-lumpsum-asset-that-is-acquired-midyear"></a>How is equally divided depreciation calculated for a lumpsum asset that is acquired midyear?
...
## <a name="how-is-depreciation-calculated-using-the-equally-divided-depreciation-method-if-the-asset-calendar-is-changed-during-the-asset-life-cycle"></a>How is depreciation calculated using the equally divided depreciation method if the asset calendar is changed during the asset life cycle?
...
[(JPN) Fixed asset depreciation](fixed-asset-depreciation-japan.md)
