...
# <a name="vat-statement-details-for-austria"></a>VAT statement details for Austria
...
## <a name="set-up-sales-tax-codes-and-sales-tax-reporting-codes-for-vat-reporting"></a>Set up sales tax codes and sales tax reporting codes for VAT reporting
