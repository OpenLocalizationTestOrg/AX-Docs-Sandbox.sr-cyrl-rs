...
ms.openlocfilehash: 85dfb0d93242409a2d43aaf078cf9c08dbe3d9da
ms.lasthandoff: 02/22/2017


---

# <a name="italian-sales-tax-books"></a>Italian sales tax books
...
## <a name="set-up-sales-tax-books"></a>Set up sales tax books
...
## <a name="set-up-sales-tax-book-sections"></a>Set up sales tax book sections
...
## <a name="sales-tax-book-status"></a>Sales tax book status
...
### <a name="change-first-page-number-dialog-box"></a>Change first page number dialog box
...
## <a name="using-sales-tax-books"></a>Using sales tax books
