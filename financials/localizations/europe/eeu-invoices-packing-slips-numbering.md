...
ms.openlocfilehash: 15dc08eac8b25b53db0abd37b63960479977c074
ms.lasthandoff: 02/22/2017


---

# <a name="invoice-and-packing-slip-numbering-for-latvia-and-lithuania"></a>Invoice and packing slip numbering for Latvia and Lithuania
...
## <a name="set-up-number-sequences-for-invoices-and-packing-slips"></a>Set up number sequences for invoices and packing slips
...
## <a name="set-up-document-selfnumbering-ranges"></a>Set up document selfnumbering ranges
...
## <a name="affected-processes"></a>Affected processes
