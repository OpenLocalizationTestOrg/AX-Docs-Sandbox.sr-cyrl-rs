...
# <a name="security-roles-in-the-public-sector"></a>Security roles in the public sector
...
## <a name="what-are-the-prerequisites-for-assigning-security-roles-in-the-public-sector"></a>What are the prerequisites for assigning security roles in the public sector?
...
## <a name="which-roles-do-i-have-to-assign"></a>Which roles do I have to assign?
After users are in the system, there are two roles that you might have to set up for public sector organizations:

-   Project manager
-   Purchasing agent

### <a name="what-is-the-project-manager---public-sector-role"></a>What is the Project manager - Public sector role?
...
### <a name="what-is-the-purchasing-agent---public-sector-role"></a>What is the Purchasing agent - Public sector role?
